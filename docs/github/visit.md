...
正如 [Github 简介/网络连接][connection] 中所说，Github 可能无法在你所在的地区正常访问。因此本篇列出了一些专门的 Github 加速工具及其使用教程。请放心，本篇的工具软件**完全没有任何法律风险**。
...
![Watt Toolkit 的下载界面](../assets/img/watt-toolkit-download-site.png)
/// caption
Watt Toolkit 的下载界面
///
...
![Watt Toolkit 的加速界面](../assets/img/watt-toolkit-acceleration-panel.png)
/// caption
Watt Toolkit 的加速界面
///

!!! info "泛 Unix 系统的权限设置"
    Watt Toolkit 需要高级网络权限，可能会被泛 Unix 系统（Linux 和 macOS）阻止。此时请 [打开此链接][unix-host-access]，按照指示操作即可。
